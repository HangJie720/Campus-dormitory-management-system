...
<center>
  <table width="900" border="0" cellspacing="0" cellpadding="0">
    <tr>
      <td height="60" bgcolor="#E6F5FF" style="color:#DA70D6; font-size:25px; font-weight:bolder; padding-left:50px;" background="Images/LoginBg.jpg"><marquee direction=right behavior="ALTERNATE">校园宿舍管理系统</marquee></td>
    </tr>
    <tr>
            ...
            <tr>
              <td height="470" align="center" valign="top" bgcolor="#F6F9FE"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                <tr align="center"  class="t1">
                  ...
                  <s:iterator id="aa" value="recordlist">
                    <tr align="center">
    ...
    <tr>
      <td height="35" background="Images/bootBg.jpg" align="right">
      <%@ include file="/pager/StudentLogpager.jsp" %>
    </tr>
  </table>
